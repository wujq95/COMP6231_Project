...
public class EuGameServer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Europe server3 has been started");
        ...
        try{
            ...
            System.out.println("Europe Server3 is ready and listening ...  ...");
        ...
        System.out.println("Europe Server3 Exiting ...");
    }
    ...
    public static void serverReceive(){
        ...
        try {
            aSocket = new DatagramSocket(PortConfig.replicaEU3);
    ...
    public static void load() throws IOException {
        FileReader fr = new FileReader("src/replica3/eu/euAccounts.txt");
