...
public class Logger {
    ...
    public static void serverLog(String serverName, String msg) throws IOException {
        String path = "src/replica3/logger/logs/serverLogs/"+serverName+"ServerLog.txt";
    ...
    public static void playerLog(String serverName,String playerUserName, String msg) throws IOException {
        String path = "src/replica3/logger/logs/"+serverName+"PlayerLogs/"+playerUserName+".txt";
        File file = new File(path);
        if(file.exists()) {
            FileWriter fileWriter = new FileWriter(path, true);
            PrintWriter printWriter = new PrintWriter(fileWriter);
    ...
    public static void adminLog(String msg) throws IOException {
        String path = "src/replica3/logger/logs/adminLogs/adminLog.txt";
        File file = new File(path);
        if(file.exists()) {
            FileWriter fileWriter = new FileWriter(path, true);
            PrintWriter printWriter = new PrintWriter(fileWriter);
