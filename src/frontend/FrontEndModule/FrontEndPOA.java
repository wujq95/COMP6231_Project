...
/**
* FrontEndModule/FrontEndPOA.java .
 ...
 implements FrontEndOperations, org.omg.CORBA.portable.InvokeHandler
{
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // FrontEndModule/FrontEnd/createPlayerAccount
       {
       ...
       case 1:  // FrontEndModule/FrontEnd/playerSignIn
       {
         String userName = in.read_string ();
         String password = in.read_string ();
         String ipAddress = in.read_string ();
       ...
       case 2:  // FrontEndModule/FrontEnd/playerSignOut
       {
         String userName = in.read_string ();
         String ipAddress = in.read_string ();
         String $result = null;
       ...
       case 3:  // FrontEndModule/FrontEnd/getPlayerStatus
       {
       ...
       case 4:  // FrontEndModule/FrontEnd/transferAccount
       {
         String userName = in.read_string ();
         String password = in.read_string ();
       ...
       case 5:  // FrontEndModule/FrontEnd/suspendAccount
       {
         String adminUsername = in.read_string ();
         String adminPassword = in.read_string ();
         String ipAddress = in.read_string ();
       ...
       case 6:  // FrontEndModule/FrontEnd/shutdown
       {
         this.shutdown ();
         out = $rh.createReply();
         break;
  ...
  private static String[] __ids = {
    "IDL:FrontEndModule/FrontEnd:1.0"};
