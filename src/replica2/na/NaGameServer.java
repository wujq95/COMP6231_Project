...
public class NaGameServer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("North America server2 has been started");
        ...
        try{
            ...
            System.out.println("North America Server2 is ready and listening ...  ...");
        ...
        System.out.println("North America Server2 Exiting ...");
    }
    ...
    public static void serverReceive(){
        ...
        try {
            aSocket = new DatagramSocket(PortConfig.replicaNA2);
    ...
    public static void load() throws IOException {
        FileReader fr = new FileReader("src/replica2/na/naAccounts.txt");
